...
Otherwise just include `pubsub.min.js` somewhere in your document. The module supports AMD, Node.js or Browserify module loaders. Note that this uses the `interface` version of the module. See below for more details.
